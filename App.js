...
class App extends Component {
  ...
  console.log(chk);
    ...
    if(localStorage.getItem('quizStarted') == 'yes'){
      ...
      console.log(thisjs);
      // var startedQuizL = JSON.parse(localStorage.getItem('startedQuiz'));
      // var openQuizPageL = JSON.parse(localStorage.getItem('openQuizPage'));
      // var msqNumL= JSON.parse(localStorage.getItem('msqNum'));
      // console.log(startedQuizL);
      // console.log(openQuizPageL);
      // console.log(msqNumL);
      // this.state.startedQuiz = startedQuizL;
      // this.state.openQuizPage = openQuizPageL;
      // this.state.msqNum = msqNumL;
      // this.state.listDis = false;
...
upDateLocalStorage(){
  console.log('chlgya1');
  var acounts = [
    {name: "Muneeb",email: "muneebwasikhan@gmail.com",password:"123456"},
    {name: "aqib",email: "aqib@gmail.com",password:"123456"}
  ]
...
chkLogin(){
  // console.log('chlgya');
  // const { quizList,listDis,openQuizPage,user,startedQuiz,startPage,keyChecked,msqNum,chks,result,length,percentage,trues } = this.state;
  var chk= localStorage.getItem('quizAppLogin');
  // console.log(chk);
  if(chk == "yes"){
  console.log(chk);
 ...
 startFunc(index){
    ...
    console.log(openQuizPage.list[index]);
